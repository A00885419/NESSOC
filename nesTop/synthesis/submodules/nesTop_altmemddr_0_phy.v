// megafunction wizard: %altmemphy v16.1%
// GENERATION: XML

// ============================================================
// Megafunction Name(s):
// 			nesTop_altmemddr_0_phy_alt_mem_phy
// ============================================================
// Generated by altmemphy 16.1 [Altera, IP Toolbench 1.3.0 Build 196]
// ************************************************************
...
module nesTop_altmemddr_0_phy (
	...
	nesTop_altmemddr_0_phy_alt_mem_phy	nesTop_altmemddr_0_phy_alt_mem_phy_inst(
	...
	defparam
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.FAMILY = "Cyclone IV E",
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MEMTYPE = "DDR2",
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "HIGH",
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN3",
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DQS_PHASE = 9000,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 3,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 8,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 2,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CS_WIDTH = 1,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CS_PER_RANK = 1,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DM_WIDTH = 1,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DM_PINS_EN = 1,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DQ_PER_DQS = 8,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DQS_WIDTH = 1,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_OCT_EN = 0,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 1,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 5000,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "5000 ps",
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 1074,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 1024,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 48,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.SCAN_CLK_DIVIDE_BY = 2,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_DQSN_EN = 0,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.DLL_EXPORT_IMPORT = "EXPORT",
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.MEM_IF_ADDR_CMD_PHASE = 90,
		nesTop_altmemddr_0_phy_alt_mem_phy_inst.RANK_HAS_ADDR_SWAP = 0;
endmodule
...
// Retrieval info: <MEGACORE title="ALTMEMPHY"  version="16.1"  build="198"  iptb_version="1.3.0 Build 196"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.DDRPHYMVCModel"  active_core="nesTop_altmemddr_0_phy_alt_mem_phy" >
...
// Retrieval info:      <PRIVATE name = "ref_clk_source" value="clock"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "alt_top" value="nesTop_altmemddr_0_phy_alt_mem_phy_seq_wrapper"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "filename" value="nesTop_altmemddr_0_phy_alt_mem_phy_seq_wrapper.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen2">
// Retrieval info:      <PRIVATE name = "family" value="Cyclone IV E"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "command" value="--simgen_arbitrary_blackbox=+nesTop_altmemddr_0_phy_alt_mem_phy_seq_wrapper;+nesTop_altmemddr_0_phy_alt_mem_phy_reconfig;+nesTop_altmemddr_0_phy_alt_mem_phy_pll;+nesTop_altmemddr_0_phy_alt_mem_phy_delay --ini=simgen_tri_bus_opt=on"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=C:\Users\sear\AppData\Local\Temp\alt7254_6217775316774388400.dir\0001_iptb_gen/nesTop_altmemddr_0_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:      <PRIVATE name = "filename" value="nesTop_altmemddr_0_phy_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
